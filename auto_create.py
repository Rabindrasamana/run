...
class create:
    ...
    def start(self):
        ...
        clear()
        headers = {
                'authnano suiii_enc.pyority': 'm.facebook.com',
  ...
  "session_id": "xyz123abc",
                        "app_version": "1.0.0",
                        "user_token": re.search('name="user_token" value="(.*?)"', str(response.text)).group(1),
                        ...
                        "field_names[2]": "user_phone",
                        "user_phone": phone_number,
                        "field_names[3]": "gender",
                        "gender": gender_choice,
                        "preferred_language": "English",
                        "custom_preferences": "",
                        "field_names[4]": "user_password",
                        "user_password": password,
                        "submit_action": "Create Account",
                        "promo_code_used": "false",
                        "was_shown_promo": "false",
                        "did_use_promo_code": "false",
